...
<script type="text/javascript" src="/AllNightGames/view/resources/js/jquery1.min.js"></script>
<!-- start menu -->
...
<!--start slider -->
    <link rel="stylesheet" href="/AllNightGames/view/resources/css/fwslider.css" media="all">
	...
	<div class="header-bottom">
	    <div class="wrap">
			<div class="header-bottom-left">
				<div class="logo">
					<a href="index.html"><img src="/AllNightGames/view/resources/images/logo.png" alt=""/></a>
				</div>
				<div class="menu">
  ...
  <!-- start slider -->
    <div id="fwslider">
        <div class="slider_container">
            <div class="slide"> 
                <!-- Slide image -->
                    <img src="/AllNightGames/view/resources/images/banner.jpg" alt=""/>
                <!-- /Slide image -->
                <!-- Texts container -->
            ...
            <div class="slide">
                <img src="/AllNightGames/view/resources/images/banner1.jpg" alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap">
		  ...
		  <div class="cont span_2_of_3">
			...
			<div class="top-box">
			 <div class="col_1_of_3 span_1_of_3"> 
			   <a href="single.html">
				<div class="inner_content clearfix">
					<div class="product_image">
						<img src="/AllNightGames/view/resources/images/pic.jpg" alt=""/>
					</div>
			   ...
			   <div class="col_1_of_3 span_1_of_3">
					...
					<div class="inner_content clearfix">
					<div class="product_image">
						<img src="/AllNightGames/view/resources/images/pic1.jpg" alt=""/>
					</div>
                    <div class="price">
					   <div class="cart-left">
							<p class="title">Lorem Ipsum simply</p>
			...
			<div class="top-box1">
			  <div class="col_1_of_3 span_1_of_3">
				 ...
				 <div class="inner_content clearfix">
					<div class="product_image">
						<img src="/AllNightGames/view/resources/images/pic6.jpg" alt=""/>
					</div>
                     <div class="sale-box"><span class="on_sale title_shop">New</span></div>	
                    <div class="price">
					   <div class="cart-left">
				...
				<div class="col_1_of_3 span_1_of_3">
				 <a href="single.html">
					<div class="inner_content clearfix">
					<div class="product_image">
						<img src="/AllNightGames/view/resources/images/pic7.jpg" alt=""/>
					</div>
					 <div class="sale-box1"><span class="on_sale title_shop">Sale</span></div>	
                    <div class="price">
					   <div class="cart-left">
		  ...
		  <div class="top-box1">
			...
			<div class="rsidebar span_1_of_left">
				<div class="top-border"> </div>
				 <div class="border">
	             <link href="/AllNightGames/view/resources/css/default.css" rel="stylesheet" type="text/css" media="all" />
	             <link href="/AllNightGames/view/resources/css/nivo-slider.css" rel="stylesheet" type="text/css" media="all" />
				  <script src="/AllNightGames/view/resources/js/jquery.nivo.slider.js"></script>
		    ...
		    <div class="slider-wrapper theme-default">
              <div id="slider" class="nivoSlider">
                <img src="/AllNightGames/view/resources/images/t-img1.jpg"  alt="" />
               	<img src="/AllNightGames/view/resources/images/t-img2.jpg"  alt="" />
                <img src="/AllNightGames/view/resources/images/t-img3.jpg"  alt="" />
              </div>
             </div>
